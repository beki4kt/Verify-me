...
exports.FixtureProviderUnavailableError = void 0;
exports.resolveVerifierMode = resolveVerifierMode;
exports.fixtureVerification = fixtureVerification;
class FixtureProviderUnavailableError extends Error {
}
exports.FixtureProviderUnavailableError = FixtureProviderUnavailableError;
function resolveVerifierMode(env = process.env) {
    ...
    const deploymentEnvironment = (env.CHEKMI_ENV ||
        env.NODE_ENV ||
        "development").trim().toLowerCase();
    if (rawMode === "fixtures" && deploymentEnvironment === "production") {
        throw new Error("CHEKMI verifier fixtures are forbidden in the production environment.");
    }
    return rawMode;
}
function fixtureVerification(params) {
    ...
    switch (reference) {
        ...
        case "CHEKMI-OUTAGE":
            throw new FixtureProviderUnavailableError("Simulated staging provider outage.");
        default:
            return {
                ok: false,
                provider: params.provider,
                error: "Unknown staging fixture reference. Use CHEKMI-OK, CHEKMI-TIP, CHEKMI-UNDERPAID, CHEKMI-WRONG-DEST, CHEKMI-STALE, CHEKMI-NOT-FOUND, or CHEKMI-OUTAGE.",
            };
    }
}
//# sourceMappingURL=verificationFixtures.js.map