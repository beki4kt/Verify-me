            ...
            child: Column(
              ...
              children: [
                FloatingNavIsland(
                  leading: BrandLockup(
                    compact: true,
                    onLogoTap: AppVariant.exposesOperatorConsole
                        ? _openOwnerAccess
                        : null,
                  ),
                  navigation: [
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppVariant.isPublicRelease
                      ? 'BUSINESS CODE'
                      : 'MESOB-DEMO',
...
class _ProviderLogoCloud extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final enabledProviders = providers
        .where(AppVariant.isPaymentProviderEnabled)
...
class _ProductBento extends StatelessWidget {
  ...
  Widget build(BuildContext context) => LayoutBuilder(
    builder: (context, constraints) {
      final providerCount = AppVariant.enabledPaymentProviders.length;
      if (constraints.maxWidth < 800) {
        return Column(
          children: [
            const SizedBox(height: 410, child: _VerificationPreview()),
            const SizedBox(height: AppSpacing.lg),
            SizedBox(
              height: 210,
              child: _MetricPanel(
      ...
      return SizedBox(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            const Expanded(flex: 7, child: _VerificationPreview()),
