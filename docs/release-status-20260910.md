...
| Billing | Version 1.0 remains organization-only B2B access. The public app shows the Basic/Pro comparison and routes authenticated plan requests to the protected billing/support queue; it has no consumer checkout or immediate feature unlock. | Use the review notes in `store-release.md`. |
