...
| Legal URLs | Privacy, terms, support, and deletion pages are live on GitHub Pages and pass the production health check. | Confirm the support/privacy mailboxes receive messages. |
